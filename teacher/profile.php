                    ...
                    <div class="profile-card">
                        ...
                        <div class="profile-info-item">
                            ...
                            <div class="info-content">
                                ...
                                <div class="info-value"><?php echo $teacher['id_number'] ?? 'Not set'; ?></div>
                            </div>
                        </div>
                        ...
                        <?php if($section_count > 0): ?>
                            <div class="profile-info-item" style="flex-direction: column; align-items: flex-start;">
                                <div style="display: flex; align-items: center; gap: 12px; width: 100%;">
                                    ...
                                    <div class="info-content">
                                        <div class="info-label">Advisory Classes</div>
                                    </div>
                                </div>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="id_number" value="<?php echo htmlspecialchars($teacher['id_number'] ?? ''); ?>" placeholder="Enter your ID number">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="specialization" value="<?php echo isset($_POST['specialization']) ? htmlspecialchars($_POST['specialization']) : ''; ?>" placeholder="e.g., Mathematics, Science, English">
                            </div>
