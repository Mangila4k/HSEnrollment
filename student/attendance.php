...
while($record = $all_records->fetch_assoc()) {
    ...
    if($record['status'] == 'Present') $attendance_by_subject[$subject]['present']++;
    elseif($record['status'] == 'Absent') $attendance_by_subject[$subject]['absent']++;
    elseif($record['status'] == 'Late') $attendance_by_subject[$subject]['late']++;
}
    ...
    <style>
        * {
        ...
        .rate-circle {
            ...
            height: 150px;
            border-radius: 50%;
            background: conic-gradient(#0B4F2E 0deg <?php echo ($attendance_rate/100)*360; ?>deg, #e9ecef <?php echo ($attendance_rate/100)*360; ?>deg 360deg);
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
        ...
        .subject-stat.present .value {
            color: #28a745;
        }

        .subject-stat.absent .value {
            color: #dc3545;
        }

        .subject-stat.late .value {
            color: #ffc107;
        }
...
<body>
            ...
            <?php if($enrollment): ?>
                ...
                <div class="stats-container">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number" style="color: #28a745;"><?php echo $present_count; ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number" style="color: #dc3545;"><?php echo $absent_count; ?></div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-number" style="color: #ffc107;"><?php echo $late_count; ?></div>
                ...
                <div class="rate-card">
                    <div class="rate-circle">
                        <div class="rate-value">
                            <?php echo $attendance_rate; ?><small>%</small>
                        </div>
                    </div>
                    <div class="rate-details">
                        <h3>Your Attendance Rate</h3>
                        <p>
                            <?php if($attendance_rate >= 90): ?>
                                Excellent! You have outstanding attendance. Keep it up!
                            <?php elseif($attendance_rate >= 80): ?>
                                Good attendance. You're doing well, but there's room for improvement.
                            <?php elseif($attendance_rate >= 75): ?>
                                Satisfactory attendance. Try to minimize absences to keep up with your classes.
                            <?php else: ?>
                                Your attendance needs improvement. Regular attendance is important for academic success.
                            <?php endif; ?>
                        </p>
                        <div class="rate-legend">
                            <div class="legend-item">
                                <div class="legend-color present"></div>
                                <span>Present: <?php echo $present_count; ?> days</span>
                            </div>
                            <div class="legend-item">
                                <div class="legend-color absent"></div>
                                <span>Absent: <?php echo $absent_count; ?> days</span>
                            </div>
                            <div class="legend-item">
                                <div class="legend-color late"></div>
                                <span>Late: <?php echo $late_count; ?> days</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="GET" action="">
                        <div class="filter-grid">
                            <div class="filter-group">
                                ...
                                <input type="hidden" name="year" id="year_input" value="<?php echo $year_filter; ?>">
                            </div>
                ...
                <div class="attendance-card">
                    ...
                    <?php else: ?>
                        <div class="no-data" style="padding: 40px;">
                            ...
                            <p>No attendance records match your selected filters.</p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <?php if(!empty($attendance_by_subject)): ?>
                    <h3 style="margin: 30px 0 20px; color: var(--text-primary); font-size: 18px; display: flex; align-items: center; gap: 10px;">
                        <i class="fas fa-chart-pie" style="color: #0B4F2E;"></i> Attendance by Subject
                    </h3>
                    <div class="subjects-summary">
                        <?php foreach($attendance_by_subject as $subject_name => $stats): 
                            $subject_rate = $stats['total'] > 0 ? round(($stats['present'] / $stats['total']) * 100, 2) : 0;
                        ?>
                            <div class="subject-summary-card">
                                <div class="subject-summary-header">
                                    <div class="subject-summary-icon">
                                        <i class="fas fa-book"></i>
                                    </div>
                                    <div class="subject-summary-title">
                                        <?php echo htmlspecialchars($subject_name); ?>
                                    </div>
                                </div>
                                <div class="subject-stats">
                                    <div class="subject-stat present">
                                        <div class="value"><?php echo $stats['present']; ?></div>
                                        <div class="label">Present</div>
                                    </div>
                                    <div class="subject-stat absent">
                                        <div class="value"><?php echo $stats['absent']; ?></div>
                                        <div class="label">Absent</div>
                                    </div>
                                    <div class="subject-stat late">
                                        <div class="value"><?php echo $stats['late']; ?></div>
                                        <div class="label">Late</div>
                                    </div>
                                </div>
                                <div class="subject-rate">
                                    <span class="subject-rate-label">Attendance Rate</span>
                                    <span class="subject-rate-value"><?php echo $subject_rate; ?>%</span>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
    ...
    <script>
        // Update year input when month changes
