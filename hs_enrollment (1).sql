...
(3, 2, 17, 8, 5, 8, '', '2026-2027', 0, 'active', '2026-03-06 10:29:51', '2026-03-06 10:29:51'),
(4, 4, 18, 8, 5, 1, 'RM101', '2026-2027', 0, 'active', '2026-03-06 10:36:43', '2026-03-06 10:36:43'),
(5, 4, 16, 9, 5, 7, 'RM202', '2026-2027', 0, 'active', '2026-03-06 10:37:20', '2026-03-06 10:37:20');
...
(3, 6, 4, 4, '2026-2027', 'Enrolled', '', NULL, '2026-02-25 05:09:30'),
...
(6, 12, 6, 1, '2026-2027', 'Enrolled', 'ICT', 'uploads/form138_12_1772791740.jpg', '2026-03-06 10:09:00');
...
INSERT INTO `users` (`id`, `id_number`, `fullname`, `email`, `password`, `is_approved`, `role`, `created_at`) VALUES
(1, NULL, 'John Micole S. Mangila', 'amawko@gmail.com', '$2y$10$5aFgUh3Hmp1IUbquad28oOYC55ZKir9Dk3a0ymX2ZKPmq2dMCe9iq', 1, 'Student', '2026-02-23 16:41:27'),
(2, NULL, 'Mikhail Ryan Muralla', 'kail@gmail.com', '$2y$10$NRl4dv4dZw.ENqvL4LRIM.EYJz4NCrFr5/zyfUN/iwTEm4k9aDO0K', 1, 'Student', '2026-02-23 16:43:59'),
(3, NULL, 'Jesriel', 'alegado@gmail.com', '$2y$10$NRl4dv4dZw.ENqvL4LRIM.EYJz4NCrFr5/zyfUN/iwTEm4k9aDO0K', 1, 'Student', '2026-02-23 16:44:50'),
(4, NULL, 'John Micole Mangila', 'micole@gmail.com', '123456789', 1, 'Registrar', '2026-02-23 17:11:15'),
(5, NULL, 'Registrar', 'registrar@gmail.com', '$2y$10$yZG8cjP.KMeYHlU/CghCv.nROjmtimWDqrYZzWhB2UkB.PVRZ2PrW', 1, 'Registrar', '2026-02-23 18:15:15'),
(6, NULL, 'Clyde Undang', 'undang@gmail.com', '$2y$10$ZN2zham67XphEjnMq9OKyOMuGv2Ssd9w.ucu6kGPhFK2Kt8hWAgFG', 1, 'Student', '2026-02-25 05:08:16'),
(7, NULL, 'AdminKo', 'admin@gmail.com', '$2y$10$ZN2zham67XphEjnMq9OKyOMuGv2Ssd9w.ucu6kGPhFK2Kt8hWAgFG', 1, 'Admin', '2026-02-25 17:31:12'),
(8, NULL, 'Twengcle Deguma', 'deguma@gmail.com', '$2y$10$QNz6RxhiCB0d/BgNwi7uhOEbxZNBgo3VwLwmiZuDp0r3zGcjagqlq', 1, 'Teacher', '2026-02-25 17:43:14'),
(9, NULL, 'Ashly Balbon', 'ash@gmail.com', '$2y$10$mlaBuK5GfSISJMKwXnuqO.rjroCewFjw.KXTlJoR0afmdvHhaVt.i', 1, 'Teacher', '2026-02-25 20:05:28'),
(10, NULL, 'John Phil Esconde', 'phil@gmail.com', '$2y$10$oQ/Lj4.yIP79cJVSz2uX3u7r8GALUHXx7TAg3z5Dpda9JwUl7HFnO', 1, 'Student', '2026-02-26 10:41:29'),
(11, NULL, 'Quency Frecel Waskin', 'waskin@gmail.com', '$2y$10$swVj9QegLtRb.g5KA29EJug5oxqKjHgMKhsn6fuKzQ5EuB/7oaVP.', 1, 'Student', '2026-03-02 16:33:29'),
(12, NULL, 'Kian Victorillo', 'kian@gmail.com', '$2y$10$3PNeAHfF1nmzLfSgX0pPku5pMkfDbtQQQA055ttV7FCDhgwlOjzn2', 1, 'Student', '2026-03-06 10:07:29'),
(13, NULL, 'Jorvin Pengoc', 'jorvin@gmail.com', '$2y$10$wIf/iSWfQCRtReANZTUcGuUjKj8dFvSe89.dg5HvG8fsHY5W4p3B2', 0, 'Student', '2026-03-06 11:12:01');
