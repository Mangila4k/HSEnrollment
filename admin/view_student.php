            ...
            <div class="profile-card">
                ...
                <div class="profile-info">
                    ...
                    <div class="action-buttons">
                        ...
                        <?php endif; ?>
                        <a href="?delete=<?php echo $student_id; ?>" class="btn-delete" onclick="return confirm('Are you sure you want to delete this student? This will also delete all associated records.')">
